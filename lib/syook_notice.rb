	...
	require 'httparty'
	class SyookNotice
		attr_accessor :list ,:msg
		@@header = {"Content-Type" => "application/json", "Authorization" => "#API-Bearer key/api key"}

		def initialize(list, msg)
			@list = list
			@msg = msg
		end
	...
	# l =  [ { name: 'Aniket Rao', email: 'kumarpavan1309@gmail.com', subdomain: 'sandbox' subject: 'changes to your domain' }, { name: 'Aniket Rao', email: 'pavan@syook.com', subdomain: 'sandbox', subject: 'changes to your domain' }]
